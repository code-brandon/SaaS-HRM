...
import com.xiaozheng.company.service.CoTransactionRecordService;
...
public class CoTransactionRecordController {
    @Autowired
    private CoTransactionRecordService coTransactionRecordService;
    ...
    @GetMapping("/page")
    public R<Map<String, PageUtils<CoTransactionRecordEntity>>> page(@RequestParam @ApiIgnore() Map<String, Object> params) {
        PageUtils<CoTransactionRecordEntity> page = coTransactionRecordService.page(params);
    ...
    public R<Map<String, PageUtils<CoTransactionRecordEntity>>> queryPage(@RequestBody @ApiParam(name = "", value = " 实体对象", required = true) CoTransactionRecordEntity coTransactionRecord, @RequestParam @ApiIgnore() Map<String, Object> params) {
        PageUtils<CoTransactionRecordEntity> page = coTransactionRecordService.queryPage(coTransactionRecord, params);
        return R.ok("查询成功").data("page", page);
    }
     ...
     * 保存数据
     *
     * @param coTransactionRecord 实体对象
     * @return 新增结果
     */
    @ApiOperation("保存数据")
    @PostMapping("/save")
