...
@Api(tags = "")
@RestController
@RequestMapping("pe/rolepermission")
public class PeRolePermissionController {
    @Autowired
    private PeRolePermissionService peRolePermissionService;
    ...
    public R<Map<String, PageUtils<PeRolePermissionEntity>>> queryPage(@RequestBody @ApiParam(name = "", value = " 实体对象", required = true) PeRolePermissionEntity peRolePermission, @RequestParam @ApiIgnore() Map<String, Object> params) {
        PageUtils<PeRolePermissionEntity> page = peRolePermissionService.queryPage(peRolePermission, params);
