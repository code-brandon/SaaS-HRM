...
import com.xiaozheng.generate.core.GeneratorFacade;
...
public class CodeUi extends JFrame {
	...
	public CodeUi(DataBase db) {
		this.db = db;
		this.dbName = db.getDbName();
		this.PathUrl = this.getClass().getClassLoader().getResource("templates").getPath();
		initComponents();
	}
...
//												.addComponent(jTextField4)
	...
	private void formWindowOpened(java.awt.event.WindowEvent evt) {
		...
		File directory = new File(new File(PathUrl).getAbsolutePath() + "\\模板");//设定为当前文件夹
			  ...
			  public void run(){
				  try{
					//路径map封装
						...
						//获取当前文件夹下的模板目录下的所有文件夹
						String basePath = new File(PathUrl).getAbsolutePath() + "\\模板\\"
